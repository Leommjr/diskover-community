                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="get" class="form-horizontal" name="form-indexfilter">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control input-sm" name="namecontains" id="namecontains" autocomplete="off" value="<?php echo htmlspecialchars($_GET['namecontains'], ENT_QUOTES, 'UTF-8'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <button title="reload indices and refresh list" type="button" class="btn btn-default pull-right" id="reloadindices" onclick="window.location.replace('selectindices.php?maxage=<?php echo $maxage_str ?>&namecontains=<?php echo htmlspecialchars($_GET['namecontains'], ENT_QUOTES, 'UTF-8'); ?>&reloadindices')"><i class="fas fa-sync-alt"></i> Reload indices</button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <p class="pull-right"><?php echo count($indices_filtered) . " indices found"; ?> (last updated <?php echo $indexinfo_updatetime->format('m/d/Y, h:i:s A T'); ?> <a href="selectindices.php?maxage=<?php echo $maxage_str ?>&namecontains=<?php echo htmlspecialchars($_GET['namecontains'], ENT_QUOTES, 'UTF-8'); ?>&reloadindices">update</a>)</p>
